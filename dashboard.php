    ...
    <div class="container">
        <div class="card mt-3">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <a href="lib/views/std/viewuser.php" class="btn btn-success" style="width:100%;">View Student</a>
                    </div>
                    <div class="col-md-6">
                        <a href="lib/views/std/manageuser.php" class="btn btn-danger" style="width:100%;">Edit Your Profile</a>
                    </div>
                </div>
